...
namespace Libraries
{
    public partial class DeleteLibrarian : System.Web.UI.Page
    {
        ...
        protected void ButtonDelete_Click(object sender, EventArgs e)
        {
            try
            {
                query = "delete from Librarian where IDLibrarian=" + TextBoxDelete.Text;
                ...
                Page.RegisterStartupScript("UserMsg", "<script>alert('This librarian has been deleted successfully');</script>");
            }
            catch (System.Exception ex)
            {
                myOleDbConnection.Close();
                Page.RegisterStartupScript("UserMsg", "<script>alert('Impossble to delete this librarian');</script>");
            }
        }
    }
}